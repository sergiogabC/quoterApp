export class Results{
    constructor(cost, unitPrice, unitDiscPrice, extDiscPrice,
        extCost, monthlyPriceSite, monthlyCostSite, monthlyPriceMbps,
        monthlyCostMbps, financedCapex, financedMonthlyPriceSite){
